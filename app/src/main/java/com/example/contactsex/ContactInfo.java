    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Are you susre you want to delete the contact?");
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    ApplicationClass.contacts.get(index).setName(etTel.getText().toString().trim());
                    ApplicationClass.contacts.get(index).setName(etMail.getText().toString().trim());
                    ...
                    Backendless.Persistence.save(ApplicationClass.contacts.get(index), new AsyncCallback<Contact>() {
                        ...
                        public void handleResponse(Contact response) {
                            ...
                            tvChar.setText(ApplicationClass.contacts.get(index).getName().toUpperCase().charAt(0)+"");
                            tvName.setText(ApplicationClass.contacts.get(index).getName());
                            Toast.makeText(ContactInfo.this, "Contacts successfully changed", Toast.LENGTH_SHORT).show();
                            showProgress(false);
